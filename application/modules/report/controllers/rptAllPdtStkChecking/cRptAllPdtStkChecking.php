...
class cRptAllPdtStkChecking extends Controller {
    ...
    public function __construct() {
        ...
        $this->RequestModel('report','rptAllPdtStkChecking/mRptAllPdtStkChecking');
    ...
    public function index($tParameter,$tCallType) {
        ...
        $this->tRptRoute            = 'rptAllPdtStkChecking';
    ...
    public function FSvCCallRptViewBeforePrint() {
        ...
        $this->aText = [
            // Header Report
            'tTitleReport'              => language('report/report', 'tRptTitleAllPdtStkChecking'),
            ...
            'tRptCountNumber'           => language('report/report', 'tRptCountNumber'),
            'tRptSumSaleValue'          => language('report/report', 'tRptSumSaleValue'),
        ...
        // Get Data Report
        $aDataReport        = $this->mRptAllPdtStkChecking->FSaMGetDataReport($aPackGetData); // Get Data In Table
        $aDataView = array(
        ...
        $tViewDataTable     = $this->RequestView('report','rptAllPdtStkChecking/wRptAllPdtStkCheckingHtml', $aDataView); // Get View DataTable
