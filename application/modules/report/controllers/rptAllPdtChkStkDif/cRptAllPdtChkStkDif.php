...
class cRptAllPdtChkStkDif extends Controller {
    ...
    public function __construct() {
        ...
        $this->RequestModel('report','rptAllPdtChkStkDif/mRptAllPdtChkStkDif');
    ...
    public function index($tParameter,$tCallType) {
        ...
        $this->tRptRoute            = 'rptAllPdtChkStkDif';
    ...
    public function FSvCCallRptViewBeforePrint() {
        ...
        $this->aText = [
            // Header Report
            'tTitleReport'              => language('report/report', 'tRptTitleAllPdtChkStkDif'),
        ...
        // Get Data Report
        $aDataReport        = $this->mRptAllPdtChkStkDif->FSaMGetDataReport($aPackGetData); // Get Data In Table
        $aDataView = array(
        ...
        $tViewDataTable     = $this->RequestView('report','rptAllPdtChkStkDif/wRptAllPdtChkStkDifHtml', $aDataView); // Get View DataTable
