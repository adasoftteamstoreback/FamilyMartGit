                ...
                <div>  
                    <?php if($aDataList['rtCode'] == 1){ ?>
                        <?php foreach($aDataList['raItems'] AS $key=>$aValue){  ?>
                            ...
                            <tr id="otrDocumentSuggestorder<?=$aValue['FTXrhDocNo'];?>" onclick="JSxSelectDocument(this,'<?=$aValue['FTXrhDocNo'];?>')" style="cursor: pointer;">    
                                <td nowrap class="text-left"><?=$aValue['FTXrhDocNo']?></td>
                                <td nowrap class="text-left"><?=$aValue['FDDateIns']?> <?=$aValue['FTXrhDocTime']?></td>
...
<div class="row">
    ...
    <?php if($aDataList['rtCode'] == 1){ ?>
        <div class="col-md-6">
            <div class="xWPageListDataSearchDoc btn-toolbar pull-right"> <!-- เปลี่ยนชื่อ Class เป็นของเรื่องนั้นๆ --> 
