<style>
 ...
 <div class="row">
    <div class="col-lg-12 table-responsive">
        <table class="table table-striped xCNTableHead xCNTableSearch" id="otbTableSuggestHD" style="width:100%">
            <thead>
                <tr>
                ...
                <div>  
                    <?php if($aDataList['rtCode'] == 1){ ?>
                        <?php foreach($aDataList['raItems'] AS $key=>$aValue){  ?>
                            ...
                            <tr id="otrDocumentSuggestorder<?=$aValue['FTPthDocNo'];?>" onclick="JSxSelectDocument(this,'<?=$aValue['FTPthDocNo'];?>')" style="cursor: pointer;">    
                                <td nowrap class="text-left"><?= $aValue['FTPthDocNo'] ?></td>
                                <td nowrap class="text-left"><?=substr($aValue['FDPthDocDate'],0,10)?> - <?=$aValue['FTPthDocTime']?></td>
...
<div class="row">
    ...
    <?php if($aDataList['rtCode'] == 1){ ?>
        <div class="col-md-6">
            <div class="xWPageListDataSearch btn-toolbar pull-right"> <!-- เปลี่ยนชื่อ Class เป็นของเรื่องนั้นๆ --> 
